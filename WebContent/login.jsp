...
request.getSession().setAttribute("usuario", "admin"); response.sendRedirect("admin.jsp"); 
} else { 
// Credencial invalido, lo elimino de sesion (opcional) request.getSession().setAttribute("usuario", null); 
}
%>
